    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Bau302TodoList.Models.AppDbContext>
    {
        ...
        protected override void Seed(Bau302TodoList.Models.AppDbContext context)
        {
            if (!context.Categories.Any())
            {
                ...
                var user = new ApplicationUser() { Email = "bilal@gmail.com", UserName = "bilal@gmail.com" };
                Task<Microsoft.AspNet.Identity.IdentityResult> task = Task.Run(() => manager.CreateAsync(user, "Bilal845969_"));
